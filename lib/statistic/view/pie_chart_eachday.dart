import 'package:capstone_frontend/statistic/resources/app_colors.dart';
import 'package:capstone_frontend/statistic/resources/indicator.dart';
...
class PieChartEachDay extends StatefulWidget {
  ...
  PieChartEachDay({super.key, required this.emotionList});

  @override
  _PieChart2State createState() => _PieChart2State();
}

class _PieChart2State extends State<PieChartEachDay> {
  int touchedIndex = -1;
