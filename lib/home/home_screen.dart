import 'dart:convert';
import 'package:capstone_frontend/chatbot/view/chatbot_screen.dart';
import 'package:capstone_frontend/chatbot/view/q_and_a_screen.dart';
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Row(
                    children:
                      ...
                      String imagePath =
                          emotionIconMap[emotion] ?? 'asset/img.webp';
                      // print(imagePath);
                    ...
                    child: CarouselSlider.builder(
                      ...
                      itemBuilder: (context, index, realIndex) {
                        ...
                        List<DiaryModel> filteredDiaries = diaries
                            ...
                            .toList();
                        // 첫 번째 일기 선택
                        DiaryModel? dayDiary = filteredDiaries.isNotEmpty
                            ? filteredDiaries.first
                            : null;
