...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  late DashChat _dashChat; // DashChat 위젯을 변수로 선언
    ...
    return Scaffold(
      ...
      floatingActionButton: keyboardMode == false
        ...
        child: FloatingActionButton(
          ...
          backgroundColor: isRecording ? Color(0xFFF15F5F) : Color(0xFFC9F5FF),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 120),
                Image.asset('asset/logo2.jpeg', scale: 10),
                SizedBox(width: 110),
                if (widget.status == 1) // status == 1 && count>0
                  TextButton(
                    ...
                    child: Text('일기 생성', style: TextStyle(color: Colors.black)),
                  ),
                SizedBox(width: 5),
                IconButton(
                  onPressed: () {
