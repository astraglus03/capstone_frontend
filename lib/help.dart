// import 'dart:convert';
//
// import 'package:capstone_frontend/screen/statistic/model/diary_detail_model.dart';
...
//
//   Future<List<DiaryDetailModel>> getPhoto(String userId, String date, String month, String limit) async {
...
//
//         var photoList = jsonData.map((item) => DiaryDetailModel.fromJson(item)).toList();
...
//         ),
//       ),
//       body: FutureBuilder<List<DiaryDetailModel>>(
//           future: getPhoto(userId!, 'None', 'None','None'),
//           builder: (_, AsyncSnapshot<List<DiaryDetailModel>> snapshot) {
//             if (snapshot.hasData) {
//               return Column(
